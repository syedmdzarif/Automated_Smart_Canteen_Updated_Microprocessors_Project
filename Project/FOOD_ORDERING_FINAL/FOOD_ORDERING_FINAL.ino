        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            //table select
              ...
              bill = 0;
              table1 = "on";
              Serial.print("GET /micro_smart_canteen/canteen.php?student_id=");
              client.print("GET /micro_smart_canteen/canteen.php?student_id=");
              Serial.println(ID);
              client.print(ID);
              ...
              client.println();
              client.println("Host: 192.168.43.208");
              client.println("Connection: close");
              client.println();
