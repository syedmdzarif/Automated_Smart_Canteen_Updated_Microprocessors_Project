...
const char* host = "192.168.43.208";
...
void loop(){
  //rfid
            ...
            student_id = content.substring(1);
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            else if (header.indexOf("GET /27") >= 0) {   //noodles 50
              lcd.clear();
              lcd.print("Item3-Noodles");
            ...
            else if (header.indexOf("GET /32") >= 0) {    //burger 60
              lcd.clear();
              lcd.print("Item2-Burger");
            ...
            //table select
            ...
            else if (header.indexOf("GET /table1") >= 0) {
              lcd.clear();
              lcd.print("Table1");
              ...
              client.print(String("GET http://localhost/micro_smart_canteen/connect.php?") + ("&student_id=") + student_id + ("&items=") + items + ("&table_no=") + table_no + ("&bill=") + bill + " HTTP/1.1\r\n" + "Host: " + host + "\r\n" + "Connection: close\r\n\r\n");
              bill = 0;
              
            }

            else if (header.indexOf("GET /table2") >= 0) {
              lcd.clear();
              lcd.print("Table2");
            ...
            else if (header.indexOf("GET /table3") >= 0) {
              lcd.clear();
              lcd.print("Table3");
            ...
            client.println("<body><h2>Student ID: 93 F1 C3 0B</h2>");
            //client.println(student_id);
